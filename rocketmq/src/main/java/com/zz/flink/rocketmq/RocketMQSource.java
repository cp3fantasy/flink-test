 ...
 */
package com.zz.flink.rocketmq;

import com.zz.flink.rocketmq.common.serialization.KeyValueDeserializationSchema;
import com.zz.flink.rocketmq.common.util.RetryUtil;
import com.zz.flink.rocketmq.common.util.RocketMQUtils;
import com.zz.flink.rocketmq.common.watermark.WaterMarkForAll;
import com.zz.flink.rocketmq.common.watermark.WaterMarkPerQueue;
...
import com.zz.flink.rocketmq.common.util.MetricUtils;
...
import static com.zz.flink.rocketmq.RocketMQConfig.*;
...
public class RocketMQSource<OUT> extends RichParallelSourceFunction<OUT>
    ...
    public void run(SourceContext context) throws Exception {
        ...
        int pullBatchSize = RocketMQUtils.getInteger(props, CONSUMER_BATCH_SIZE, DEFAULT_CONSUMER_BATCH_SIZE);
