...
public class PvTableTest3 {
    ...
    public static void main(String[] args) {
        ...
        TableResult result = tEnv.executeSql("insert into pv_duration select pageId, gender_result['gender'],duration,gender_result['status'], ts from pv_duration_internal where gender_result['status']='success'");
