...
public class BigHiveTableTest3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String createTable = createBigTable("big_source", 1000);
//        System.out.println(createTable);
        tEnv.executeSql(createTable);
        tEnv.useCatalog("myhive");
        tEnv.getConfig().setSqlDialect(SqlDialect.HIVE);
        createTable = createBigHiveTable("big1000", 1000);
//        System.out.println(createTable);
        tEnv.executeSql(createTable);
        tEnv.useCatalog("default_catalog");

        tEnv.getConfig().setSqlDialect(SqlDialect.DEFAULT);
        String bigSelect = createBigSelect("big_source", "myhive.flink.big1000", 1000);
