...
//                "    ts timestamp(3)\n" +
                ...
                ")";
        tEnv.executeSql(createTable);
        TableResult result = tEnv.executeSql("insert into duration_stat(gender,cnt) select gender,count(1) from pv_duration group by gender");
