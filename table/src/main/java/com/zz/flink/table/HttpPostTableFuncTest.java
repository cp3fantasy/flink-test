...
import com.zz.flink.table.udf.HttpPostTableFunc;
import org.apache.flink.streaming.api.environment.StreamExecutionEnvironment;
import org.apache.flink.table.api.EnvironmentSettings;
import org.apache.flink.table.api.bridge.java.StreamTableEnvironment;

public class HttpPostTableFuncTest {
    ...
    public static void main(String[] args) {
        ...
        tEnv.createTemporarySystemFunction("httpPost", HttpPostTableFunc.class);
        ...
        String createView = "create view view_pv as\n" +
                "select pageId,userId,resp as gender,startTime,endTime,endTime - startTime as duration,ts,status \n" +
                "from pv, LATERAL TABLE(httpPost('http://localhost:9000/user/gender',null,MAP['userId',userId]))";
